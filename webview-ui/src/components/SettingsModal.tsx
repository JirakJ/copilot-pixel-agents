  ...
  return (
    <>
      ...
      >
        ...
        <button
          onClick={() => {
            bridge.send({ type: 'openSessionsFolder' });
            onClose();
          }}
        ...
        <button
          onClick={() => {
            bridge.send({ type: 'addExternalAssetDirectory' });
            onClose();
          }}
        ...
        {externalAssetDirectories.map((dir) => (
          ...
          >
            ...
            <button
              onClick={() =>
                bridge.send({ type: 'removeExternalAssetDirectory', path: dir })
              }
        ...
        <button
          onClick={() => {
            ...
            bridge.send({ type: 'setSoundEnabled', enabled: newVal });
          }}
